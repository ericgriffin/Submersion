...
final diveSearchProvider = FutureProvider.family<List<Dive>, String>((ref, query) async {
  if (query.isEmpty) {
...
class DiveListNotifier extends StateNotifier<AsyncValue<List<Dive>>> {
  ...
  Future<Dive> addDive(Dive dive) async {
